...
namespace eShopOnContainers.Core.Services.Tisort
{
    public class TisortService : ICatalogService
    {
        ...
        public TisortService(IRequestProvider requestProvider, IFixUriService fixUriService)
        {
